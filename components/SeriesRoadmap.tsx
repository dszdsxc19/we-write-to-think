...
// Dimensions & Layout (moved outside to prevent re-creation on every render)
...
export default function SeriesRoadmap({ series, currentPostSlug, posts }: SeriesRoadmapProps) {
  ...
  // Optimized: Memoize filtering and sorting to avoid expensive operations on every render
  ...
  // Optimized: Memoize the expensive path string generation
  const pathD = useMemo(() => {
