    ...
    >
      <defs>
        ...
        <linearGradient
          ...
          y2="418.5"
        >
          <stop style={{ stopColor: '#06b6d4', stopOpacity: 1 }} offset="0%" />
          <stop style={{ stopColor: '#67e8f9', stopOpacity: 1 }} offset="100%" />
        </linearGradient>
        <path
      ...
      <g>
        <g>
          <use xlinkHref="#aFZf6T5ED" opacity="1" fill="url(#gradientb2ThqnP5Op)" />
        </g>
        <g>
          <use xlinkHref="#a9fehgwfM" opacity="1" fill="url(#gradientk1wNV9Ostb)" />
        </g>
      </g>
    </svg>
  )
